...
_The journal rank (Q4-Q1) and the conference rank (C-A*) presented here are retrived from [ScimagoJR](https://www.scimagojr.com/) and [CORE](http://portal.core.edu.au/conf-ranks/) respectively. Note that a higher conference rank does not indicate a higher impact factor (e.g., ICRA is widely regarded the most impactful publication venue in the field of [robotics](https://scholar.google.com/citations?view_op=top_venues&hl=en&vq=eng_robotics) although it got less CORE Rank than IROS). Please consult [core website](http://www.core.edu.au/conference-portal) for more detailed assessment methods._ 
